...
axios.interceptors.request.use((config) => {
    ...
    //     let arr = ['#/get-valid-code','#/register','#/register-success','#/reset','#/login'];
    ...
    if(config.method === 'post' && config.url != 'sdpbusiness/upload/uploadFile2') {
        config.headers = {
            'Accept':'*/*',
    ...
    if(config.url == 'sdpbusiness/project/projectOverviewForAjax') {
        config.headers = {
            'Accept':'*/*',
    ...
    // if(config.url == 'sdpbusiness/upload/uploadFile2') {
    //     config.headers = {
    //         'Accept':'*/*',
